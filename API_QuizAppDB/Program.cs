...
// thêm DbContext
builder.Services.AddDbContext<QuizAppDbContext>(options => options.UseSqlServer("Data Source=.;Initial Catalog=DB_QuizApp_Fina;Integrated Security=True;Trust Server Certificate=True"));
